...
class monclermodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_moncler_link(link):
                embed = discord.Embed(title="Error - Invalid Moncler link", description="Please provide a valid Moncler link.", color=PURPLE)
