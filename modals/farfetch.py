...
class farfetchmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_farfetch_link(Linkff):
                embed = discord.Embed(title="Error - Invalid Farfetch link", description="Please provide a valid Farfetch link.", color=PURPLE)
