...
class arcteryxmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_arcteryx_link(link):
                embed = discord.Embed(title="Error - Invalid Arcteryx link", description="Please provide a valid Arcteryx link.", color=PURPLE)
