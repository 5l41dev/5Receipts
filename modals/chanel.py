...
class chanelmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_chanel_link(link):
                embed = discord.Embed(title="Error - Invalid Chanel link", description="Please provide a valid Chanel link.", color=PURPLE)
