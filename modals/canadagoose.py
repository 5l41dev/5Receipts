...
class canadagoose(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_canadagoose_link(link):
                embed = discord.Embed(title="Error - Invalid Canada Goose link", description="Please provide a valid Canada Goose link.", color=PURPLE)
