...
class fightclubmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_fightclub_link(link):
                embed = discord.Embed(title="Error - Invalid Flightclub link", description="Please provide a valid Flightclub link.", color=PURPLE)
