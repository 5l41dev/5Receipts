...
class burberrymodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_burberry_link(Link):
                embed = discord.Embed(title="Error - Invalid burberry link", description="Please provide a valid burberry link.", color=PURPLE)
