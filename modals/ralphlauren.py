...
class ralphlaurenmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_rl_link(Linkff):
                embed = discord.Embed(title="Error - Invalid Ralph Lauren link", description="Please provide a valid Ralph Lauren link.", color=PURPLE)
