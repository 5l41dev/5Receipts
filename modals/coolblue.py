...
class coolbluemodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_cooblue_link(link):
                embed = discord.Embed(title="Error - Invalid Coolblue link", description="Please provide a valid Coolblue link.", color=PURPLE)
