...
class Pradamodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_prada_link(Linkff):
                embed = discord.Embed(title="Error - Invalid Prada link", description="Please provide a valid Prada link.", color=PURPLE)
