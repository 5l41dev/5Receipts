...
class breuningermodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_breuninger_link(Link):
                embed = discord.Embed(title="Error - Invalid Breuninger link", description="Please provide a valid Breuninger link.", color=PURPLE)
