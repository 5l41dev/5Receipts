...
class ckmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if not is_ck_link(link):
            embed = discord.Embed(title="Error - Invalid Culturekings link", description="Please provide a valid Culturekings link.", color=PURPLE)
