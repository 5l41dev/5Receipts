...
class trapstarmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_trapstar_link(Linkff):
                embed = discord.Embed(title="Error - Invalid Trapstar link", description="Please provide a valid Trapstar link.", color=PURPLE)
