...
class balenciagamodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_balenciaga_link(Link):
                embed = discord.Embed(title="Error - Invalid Balenciaga link", description="Please provide a valid Balenciaga link.", color=PURPLE)
