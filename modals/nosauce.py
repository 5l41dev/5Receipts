...
class nosaucemodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_nosauce_link(Linkff):
                embed = discord.Embed(title="Error - Invalid NoSauceThePlug link", description="Please provide a valid NoSauceThePlug link.", color=PURPLE)
