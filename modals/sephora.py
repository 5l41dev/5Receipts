...
class sephoranmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            embed = discord.Embed(title="🧩 One Last Step!", description="Complete the next steps to receive the receipt.", color=PURPLE)
