...
class chromemodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_chrome_link(link):
                embed = discord.Embed(title="Error - Invalid Chromehearts link", description="Please provide a valid Chromehearts link.", color=PURPLE)
