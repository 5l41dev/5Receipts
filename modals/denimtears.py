...
class denimtearsmodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            try:
                ...
                with open("receipt/updatedrecipies/updateddenim.html", "w", encoding="utf-8") as file:
                    file.write(html_content)



                sender_email = "DENIM TEARS <order@denimtears.com>"
                subject = f"Order {order_number} confirmed"

                from emails.choise import choiseView
                owner_id = interaction.user.id
                link = "https://denimtears.com"
