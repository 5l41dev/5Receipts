...
class offwhitemodal(ui.Modal, title="5Receipts"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_details:
            ...
            if not is_offwhite_link(link):
                embed = discord.Embed(title="Error - Invalid Off White link", description="Please provide a valid Off White link.", color=PURPLE)
